    ...
    <aside className="hidden min-h-screen w-72 border-r border-white/5 bg-[#020202] lg:flex flex-col">
            ...
            {({ isActive }) => (
              <>
                ...
                <item.icon
                  ...
                  className={
                    isActive ? "text-[#ef4444]" : "group-hover:text-[#ef4444] transition-colors"
                  }
                />
                {item.label}
              </>
      ...
      <div className="p-6 mt-auto border-t border-white/5 bg-gradient-to-t from-white/[0.01] to-transparent">
        {user ? (
          <div className="flex items-center justify-between gap-3 p-4 rounded-3xl bg-white/[0.03] border border-white/5 group transition-all duration-500 hover:border-white/10">
            <div className="flex items-center gap-3 overflow-hidden">
              ...
              <div className="overflow-hidden">
                ...
                <p className="text-[10px] text-white/30 truncate font-medium tracking-wider">
                  {user.email}
                </p>
              </div>
            </div>
          ...
          <NavLink
            to="/auth"
            className="flex items-center justify-center gap-2 p-4 rounded-2xl border border-white/5 text-sm text-white/40 hover:text-white hover:border-white/10 transition-all"
          >
