export function LogoMark({ className = "" }) {
  return (
    <span className={`flex h-10 w-10 items-center justify-center overflow-hidden rounded-lg border border-white/14 bg-gradient-to-br from-white to-white/90 ${className}`}>
      <svg
        viewBox="0 0 40 40"
        className="h-6 w-6"
        fill="none"
