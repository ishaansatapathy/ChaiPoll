  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <p className="text-[9px] font-black uppercase tracking-[0.4em] text-white/10 mb-4">
          {label}
        </p>
        <div className="flex items-baseline gap-4">
          ...
          <div className="flex flex-col">
            <span className="font-handwriting text-xl text-[#ef4444]/60 rotate-[-8deg]">
              {trend}
            </span>
            <span className="text-[7px] font-black text-white/5 uppercase tracking-widest mt-1 italic">
              Delta_Sync
            </span>
          </div>
        </div>
