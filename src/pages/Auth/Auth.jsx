  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#070707] font-sans selection:bg-white selection:text-black">
      ...
      <div
        ...
        style={{
          maskImage: 'linear-gradient(to top, black 0%, black 55%, rgba(0,0,0,0.65) 78%, transparent 100%)',
          WebkitMaskImage: 'linear-gradient(to top, black 0%, black 55%, rgba(0,0,0,0.65) 78%, transparent 100%)',
        }}
      >
        <img
          src={heroImage}
      ...
      <div className="relative z-10 flex min-h-screen w-full">
        ...
        <div className="relative flex-1 hidden md:flex">
          ...
          <div className="absolute top-[16%] left-[54%]">
            <RoughNotation
              ...
              padding={6}
            >
              <span className="font-handwriting text-[1.4rem] text-white/85">realtime participation</span>
            </RoughNotation>
          </div>
          ...
          <div className="absolute bottom-[6%] left-[18%]">
            <RoughNotation
              ...
              padding={8}
            >
              <span className="font-handwriting text-[1.4rem] text-white/90">better engagement</span>
            </RoughNotation>
          </div>
        ...
        <div className="relative flex w-full md:w-[35%] md:min-w-[380px] flex-col items-center justify-center p-6 sm:p-12 bg-gradient-to-l from-black/80 to-transparent md:border-l border-white/5">
          ...
          <div className="absolute bottom-8 text-white/20 text-[10px] uppercase tracking-[0.2em]">
            By continuing, you agree to our <a href="#" className="underline hover:text-white">Terms of Service</a>
          </div>
        </div>
      </div>
    </div>
